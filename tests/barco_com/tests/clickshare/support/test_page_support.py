...
def test_browse_get_warranty_info_webpage(browser_user, page_clickshare_support_get_warranty_info):
    page = page_clickshare_support_get_warranty_info
    
    browser_user.browse(page.url)
...
def test_user_can_see_forcus_effect_when_hovering_over_serial_num_input(browser_user, page_clickshare_support_get_warranty_info):
    page = page_clickshare_support_get_warranty_info
